...
from info import API_ID, API_HASH, PHONE_NUMBER
...
PRIVATE_PUBLIC = 'cash_zizy'  # скрытый паблик для управления ботом
PUBLIC_PUBLIC = 'ZizyTrade'  # паблик куда будем репостить
SOURCE_PUBLICS = [
    # список пабликов-доноров, откуда бот будет пересылать посты
    'new_group_crypto',
    'daytrader_signals',
    'teamtraders_info',
    'speculantponikolaevski',
    'binanceob',
    'cryptointradeing',
...
def post_request(client, message):
    ...
    try:
        ...
        # отправляем сообщение в скрытый оригинальный паблик
